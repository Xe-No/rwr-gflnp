...
// by BBBYJ, reviewed by Xe-No
// --------------------------------------------
class UntilDeathTimer : Tracker {
	protected GameModeInvasion@ m_metagame;
	protected bool m_started;
	protected float m_time;

	// --------------------------------------------
	UntilDeathTimer(GameModeInvasion@ metagame, float time) {
		super();
	...
	// --------------------------------------------
	void start() {
		_log("starting UntilDeathTimer", 1);
		m_started = true;
		
		m_metagame.getComms().send("<command class='set_game_timer' faction_id='0' pause='0' time='" + m_time + "' />");
	}
