...
// 白卡
array<array<ScoredResource@>> reward_white = {
    {
        // 0.40
        ScoredResource("gw_k2.weapon", "weapon", 3.0f),
        ScoredResource("gw_mondragon_m1908.weapon", "weapon", 3.0f),
        ScoredResource("gw_svch.weapon", "weapon", 3.0f),
        ScoredResource("gw_pm1910.weapon", "weapon", 3.0f),
        ...
        ScoredResource("gw_derringer.weapon", "weapon", 1.0f),  //0.36
        ScoredResource("gw_fedorov.weapon", "weapon", 1.0f),    //0.36
        ScoredResource("gw_kolibri.weapon", "weapon", 1.0f),    //0.36
    ...
    {   
        ...
        ScoredResource("gw_type80.weapon", "weapon", 1.0f),     //0.36
...
//白卡 MG/SG
array<array<ScoredResource@>> reward_white_mgsg = {
    {
        // 0.40
        ScoredResource("gw_fo-12.weapon", "weapon", 3.0f),    
...
// 白卡 AR/SMG
array<array<ScoredResource@>> reward_white_arsmg = {
    {
        // 0.40
        ScoredResource("gw_hk433.weapon", "weapon", 3.0f),  //0.4   
        ScoredResource("gw_k2.weapon", "weapon", 3.0f),
        ScoredResource("gw_qbu191.weapon", "weapon", 3.0f),
        ScoredResource("gw_scr_f.weapon", "weapon", 3.0f),
...
// 白卡 HG/RF
array<array<ScoredResource@>> reward_white_hgrf= {
    {
        ScoredResource("gw_m1873.weapon", "weapon", 1.0f), 
        ScoredResource("gw_m9.weapon", "weapon", 1.0f), 
        ScoredResource("gw_c96.weapon", "weapon", 1.0f), 
...
// 装备
array<array<ScoredResource@>> reward_equip = {
    {
...
//黑卡
array<array<ScoredResource@>> reward_black = {
    {
        // 0.39
    ...
    {
        // 0.40
        ScoredResource("gw_98kmod3.weapon", "weapon", 3.0f),
        ScoredResource("gw_80mod3.weapon", "weapon", 3.0f),
        ScoredResource("gw_xm8mod3.weapon", "weapon", 3.0f),
        ScoredResource("gw_m1918barmod3.weapon", "weapon", 3.0f),              
...
// Black Card(AR SMG HG)
array<array<ScoredResource@>> reward_black_arsmghg = {
    {
        // 0.40
        ScoredResource("gw_m1918barmod3.weapon", "weapon", 3.0f),    
    ...
    {
        //0.40
        ScoredResource("gw_xm8mod3.weapon", "weapon", 3.0f),          //0.4
...
// Black Card(RF SG MG)
array<array<ScoredResource@>> reward_black_rfsgmg = {
    {
        ScoredResource("gw_negev_904.weapon", "weapon", 1.0f), 
        ScoredResource("gw_supersass_1407.weapon", "weapon", 1.0f),
        ScoredResource("gw_supersass_mod.weapon", "weapon", 1.0f),
        ...
        ScoredResource("gw_ltlx7000_6101_b.weapon", "weapon", 1.0f),    
        ScoredResource("gw_ntw20mod3.weapon", "weapon", 1.0f),
        ScoredResource("gw_lee_enfield_10.weapon", "weapon", 1.0f),     
        ScoredResource("gw_cslr4.weapon", "weapon", 1.0f)
    },
    {
        // 0.40
...
// Playbox
array<array<ScoredResource@>> reward_pb = {
    {
    ...
    },
    {
        ...
        ScoredResource("ew_martini_henry.weapon", "weapon", 1.0f),  
        ScoredResource("gw_3x_railgun.weapon", "weapon", 1.0f), 
        ScoredResource("ew_reisenu_a.weapon", "weapon", 1.0f, 5),   
        ScoredResource("gw_km.weapon", "weapon", 1.0f, 5),  
        ScoredResource("gw_ogris.weapon", "weapon", 1.0f),  
        ScoredResource("gw_m4a1_pinkglassheart.weapon", "weapon", 1.0f),
        ScoredResource("ew_diamondsword.weapon", "weapon", 1.0f)  
    }
};
...
array<array<ScoredResource@>> reward_vb1 = {
    {
        ...
        ScoredResource("gtr_flare.projectile", "projectile", 1.0f, 2),
        ScoredResource("wcsp_flare.projectile", "projectile", 1.0f, 2),
...
// UR
array<array<ScoredResource@>> reward_ur = {
    {
    ...
    { 
        // 0.38
        ScoredResource("ew_sinteria_bow.weapon", "weapon", 2.0f),
        ...
        ScoredResource("ew_megumin_wand_float.weapon", "weapon", 1.0f),     
        ScoredResource("gw_hrg_bastion.weapon", "weapon", 1.0f),        
        ScoredResource("ew_hongxue_1.weapon", "weapon", 1.0f),      
        ScoredResource("gw_sat8_2601.weapon", "weapon", 1.0f),      
        ScoredResource("ew_xenophage.weapon", "weapon", 1.0f),      
        ScoredResource("gw_g41_7406.weapon", "weapon", 1.0f),       
        ScoredResource("ew_pm1.weapon", "weapon", 1.0f),        
        ScoredResource("ew_leviathan_breath.weapon", "weapon", 1.0f),       
        ScoredResource("ew_kokomi_portia.weapon", "weapon", 1.0f),      
...
// SR
array<array<ScoredResource@>> reward_sr = {
    {
    ...
    {
        ScoredResource("ew_momoi_g3.weapon", "weapon", 2.0f),   // 0.40
        ScoredResource("ew_akayo_1145.weapon", "weapon", 1.0f), // 0.39
...
// SSR
array<array<ScoredResource@>> reward_ssr = {
    {
    ...
    { 
        ...
        ScoredResource("ew_mk18cqb_hkykn.weapon", "weapon", 1.0f),      
        ScoredResource("ew_chameleon.weapon", "weapon", 1.0f),      
        ...
        ScoredResource("ew_sentinel.weapon", "weapon", 2.0f),       //2x up 0.38
