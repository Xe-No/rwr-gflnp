...
class StageConfiguratorInvasion : StageConfigurator {
	...
	const array<FactionConfig@>@ getAvailableFactionConfigs() const {
		...
		availableFactionConfigs.push_back(FactionConfig(-1, "grey.xml", "G&K PMC", "0.5 0.5 0.5", "grey_boss.xml"));
		availableFactionConfigs.push_back(FactionConfig(-1, "infected.xml", "Infected", "1 0.1 0.1", "infected.xml"));
		availableFactionConfigs.push_back(FactionConfig(-1, "blackrabbit.xml", "Black Rabbit Squad", "0.5 0.25 0", "blackrabbit.xml"));
	...
	protected Stage@ setupViper() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/viper";
	...
	protected Stage@ setupRoberto() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/roberto";
	...
	protected Stage@ setupClairemont() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/clairemont";
	...
	protected Stage@ setupStage1() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map2";
	...
	protected Stage@ setupStage2() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map4";
	...
	protected Stage@ setupStage3() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map3";
	...
	protected Stage@ setupStage4() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map7";
...
//		stage.addTracker(Spawner(m_metagame, 1, Vector3(446,0,539)));
	...
	protected Stage@ setupStage5() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map1";
	...
	protected Stage@ setupStage6() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map5";
	...
	protected Stage@ setupStage7() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map6";
	...
	protected Stage@ setupStage8() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map8";
	...
	protected Stage@ setupStage9() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map9";
	...
	protected Stage@ setupStage10() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map10";
...
// faction 0 had 2 bases to start with (a dummy one), now only 1
	...
	protected Stage@ setupStage11() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map13";
	...
	protected Stage@ setupStage12() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map14";
...
//		stage.addTracker(Spawner(m_metagame, 1, Vector3(658,10,374), 10));        // vulcan slot filler
	...
	protected Stage@ setupStage13() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map16";
...
// attack score is taken from the map16 attack handler script, if bases => 5    
	...
	protected Stage@ setupStage15() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map1_2";
...
// attack score is taken from the map1_2 attack handler script, if bases => 11    
	...
	protected Stage@ setupStage16() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map8_2";
	...
	protected Stage@ setupStage17() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map17";
	...
	protected Stage@ setupFinalStage1() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map11";
	...
	protected Stage@ setupFinalStage2() {
		...
		stage.m_mapInfo.m_path = "media/packages/GFL1_halloween/maps/map12";
	...
	protected array<ResourceChange@>@ getCommonFactionResourceChanges() const {
		...
		list.push_back(ResourceChange(Resource("a10_gun_run.call", "call"), false));
		list.push_back(ResourceChange(Resource("gunship_run.call", "call"), false));        
