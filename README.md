...
## 0.36j	测试B版
	1.新增信物：A-PI（闪光弹）	Angelia（C4） Dima（C4，CBP直售，不复活自带）
	2.修复A版测试部分问题：VP1915枪声过大 wand火球声音过大 劫豹武器未注册 Derringer模型修复
	3.新武器：
		①MK18CQB[HEAVYSLUG]		SSR					KEILSAMA投稿	AR+SG 主模式35发 低后座 1.5致死 1.1视野	0.3-0.55射程
																			副模式3发 6.18致死 140弹速 0.2-0.6射程 1.1视野
		②Chameleon[Dima]			SSR					Michlelle投稿	AR 45发 极低后座力 1.53致死 1.2视野 900射速
		③鸿雪						UR					GHOST141投稿	ASR+GL 主模式3发 2.0范围 1.31*5伤害 2.0视野 -0.1移速 射击间隔1.3 装填时间1.5
																			副模式为模式3 5.0范围 0.1*3伤害 QLU式弹道 散射 略微不准 1.5秒重新射击时间
		④Martini Henry				玩具				KURUMI投稿		RF 1发 6.5致死 0.2-0.6射程 150弹速 -0.08移速	二模式为刺刀模式，增加嘲讽0.7，移速+0.15，抗致死0.15，有盾块
	4.GHOST护甲更换HUD
	5.更换AR15.50 BEOWULF的人物模型为LVOAC人物模型
	6.所有插板的所有层移速增加0.1
	7.HVY3专属护甲所有层移速增加0.05
	8.X2 T2外骨骼的嘲讽移除（方便跑尸）
	9.UR SSR相关CBP脚本应用写入
	10.增加G41BP2064 HK416MOD3 9A91子弹咖啡馆 KSVKMOD3 PPSH41MOD3 LTLX7000夜潮的邀约 6把武器的黑卡烙印
	11.LTLX7000的UR能够与辩护者搭配变为白卡皮肤
	12.MG4转化器A10信标不会被载具与步兵识别
	13.9A91子弹咖啡馆致死1.45增加至1.51射程0.4-0.65降低至0.3-0.55，站姿精准0.9增加至0.94，移速-0.015增加至+0.1
	14.ASVAL三改致死1.65降低至1.51，射速720增加至900，后座力降低至小，后座恢复力下降40%，视野1.35降低至1.3，弹速170降低至140
	15.G41BP2064更换HUD
	16.HK416三改 射速550增加至850，后座进行了射速变化适应，榴弹弹道改变
	17.IDW三改 致死1.5降低至1.4
	18.KSVK三改 伤害0.69*9降低至0.69*7，射击间隔1.5秒延长至1.8秒

## 0.36k	测试C版
	1.修改黑卡李恩菲尔德的装弹动作，其2模式爆发模式精准度1降低至0.95
	2.修复C4蒂玛的模型
	3.ERC的狙击支援价格从75上升至100
	4.修复MG4信标A10的脚本，防止恶意脚本崩溃，MG4信标生效时间从4秒降低至2.5秒，弹道不变，弹道速度增加，投掷过程中有更加明显的绿色标记
	5.修复RPL20通机不能分解合成的问题，RPL20通机的主模式爆炸范围2.0降低至1.8，副模式后座力上升至MG水平
	6.修改MG4TD MG4A3TD的弹道特效表现
	7.降低KN57 VP1915枪声音量
	8.AR14B消音模式特效改回
	9.威廉姆斯.22致死1.5降低至1.45，基础精准1.1改回至1.0
	10.伊露露信物伤害修复，修复其落地不会消失的问题
	11.MG338改为传统MG，致死1.7，2模式为蹲射
	12.MK18弹道改为蓝色
	13.wand法杖修改名字，一模式射击位置上升至0.8防止卡入地面
	14.双重解放枪口位置Y:0.3 Z:2.4 改为Y:0 Z:1.2
	15.HRG的二模式取消抗致死
	16.SCT3的专属黏弹PUSH降低至0.75
	17.25A2K的盾块增加Y0.1 Z0.2
	18.M37 SSR的射击模式变为泵动式，弹速120补正为130，射击音量降低
	19.鸿雪1模式伤害降低为1.21*5，射击间隔1.3改为1.55，范围2降低至1.5，2模式视野1.4降低至1.2，加入射击间隔1.8秒
	20.XM177E2特效位置转移
	21.沉默小姐的2模式曲射榴弹射击间隔从1.5秒延长至2.2秒
	22.变色龙SSR的视野1.2降低至1.0，弹速155降低至150，后座力回复降低20%，弹容45增加至55发
	23.ERC的ECM生效时间变为60的改动进行了音效适配，且ECM重量降至2%，ECM能携带6个，原为4个，价格上升至85rp
	24.修复G41R保护时间不对的问题
	25.AGS30架设模式弹道修改
	26.UD1 UD3地图敌人数量修改，UD2敌方阵营数降至1，UD4暂时移除出EX

## 0.36l	基础测试完毕
	1.鸿雪射击1模式间隔改为1.5秒，伤害改为1.25；2模式弹道修改，视野改为1.3，爆炸范围改至5.5
	2.变色龙TARIL修改
	3.williams.22 走射精准0.8增加至0.93，站射精准0.9增加至0.98，架设精准1.05降低至1.0
	4.HRG恢复0.2架设抗致死，架设模式移速降低为0.3
	5.RO635的标准模式移速+0.11降低至+0.01，后座力扩散0.265减小至0.25，致死1.36增加至1.
	6.猫猫继承人重量改为40%
	7.增加MP9的模型
	8.降低HK416星之茧的烟幕效果
...
## 0.36m	载具
	1.信物：提尔比茨
	2.武器：光剑-彩票
	3.载具：M5APC、挑战者2TES、刻托（Cetus）机动坦克、T90主战坦克、Strv122A主战坦克
		M5APC：冰淇淋车、VB、PZC 
		刻托：KCCO-EX、PZC
		TES：PZC
		T90：VB、PZC
