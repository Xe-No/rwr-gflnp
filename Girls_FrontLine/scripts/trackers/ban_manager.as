...
class BanManager : Tracker {
	...
	protected string m_whiteFilename = "whitelist_username.xml"; 
	...
	protected array<string> m_whiteList;
	...
	protected void refresh() {
		m_whiteList = loadData(m_whiteFilename);
		...
		_log(m_usernameList.size() + " whitelist loaded");
...
//		for (uint i = 0; i < m_whiteList.size(); ++i) {
//			string pattern = m_whiteList[i];
//			// TODO: not a pattern check anymore
//			//if (pattern == name.toLowerCase()) {
//			if (matchString(name, pattern)) {
//				return false;
//			}
//		}
//		_log("BanManager: player=" + name + " not in whitelist");
//		kickPlayer(id, "Kicked - Not in whitelist");
//		return true;
	...
	protected void handleBaseOwnerChangeEvent(const XmlElement@ event) {
		Tracker::handleBaseOwnerChangeEvent(event);
