...
class StageConfiguratorInvasion : StageConfigurator {
	...
	// addStage(setupUntildeath2());	//0.37.1反馈移除
...
//		stage.addTracker(Spawner(m_metagame, 1, Vector3(446,0,539)));
	...
	protected Stage@ setupIntrusion() {
		Stage@ stage = createStage();
		stage.m_mapInfo.m_name = "intrusion";
        stage.m_mapInfo.m_path = "media/packages/GFLNP_INF/maps/intrusion";
		stage.m_mapInfo.m_id = "intrusion";
	...
	protected Stage@ setupUprising() {
		Stage@ stage = createStage();
		stage.m_mapInfo.m_name = "uprising";
        stage.m_mapInfo.m_path = "media/packages/GFLNP_INF/maps/uprising";
		stage.m_mapInfo.m_id = "uprising";
	...
	protected Stage@ setupUntildeath() {
		Stage@ stage = createStage();
		stage.m_mapInfo.m_name = "untildeath";
		stage.m_mapInfo.m_path = "media/packages/GFLNP_INF/maps/untildeath";
		stage.m_mapInfo.m_id = "untildeath";
		...
		stage.m_maxSoldiers = 170;     // was 33 * 3 in 1.65
		stage.m_playerAiCompensation = 4;                                         // was 5 (test4)
	...
	protected Stage@ setupUntildeath2() {
		Stage@ stage = createStage();
		stage.m_mapInfo.m_name = "untildeath2";
		stage.m_mapInfo.m_path = "media/packages/GFLNP_INF/maps/untildeath2";
		stage.m_mapInfo.m_id = "untildeath2";
		...
		stage.m_maxSoldiers = 45 * 5;     // was 33 * 3 in 1.65
		stage.m_playerAiCompensation = 4;                                         // was 5 (test4)
		stage.m_playerAiReduction = 2;                                            // wasn't set in 1.65, thus 0   
		stage.m_soldierCapacityModel = "constant";
		...
		stage.m_defenseWinTime = 900.0;   // was 600 in 1.65
		stage.m_defenseWinTimeMode = "custom";
		stage.addTracker(UntilDeathTimer(m_metagame, stage.m_defenseWinTime));
	...
	protected Stage@ setupUntildeath3() {
		Stage@ stage = createStage();
		stage.m_mapInfo.m_name = "untildeath3";
		stage.m_mapInfo.m_path = "media/packages/GFLNP_INF/maps/untildeath3";
		stage.m_mapInfo.m_id = "untildeath3";
